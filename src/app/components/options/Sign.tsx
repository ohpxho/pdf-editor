...
export default function Sign() {
	...
	const onSignatureUpload = useCallback(
		(src: string): void => {
			if (!src || !pdf) return;
		...
		<div className="w-full flex flex-col gap-4">
			<Dialog open={open} onOpenChange={setOpen}>
				<DialogTrigger asChild>
					<Button className="flex w-full items-center justify-center gap-4 border border-gray-300 rounded-sm px-4 py-2 bg-white cursor-pointer hover:bg-blue-100 hover:border-blue-600 transition-colors shadow-sm text-black hover:text-blue-600">
						<Plus />
					...
					<div className="relative flex flex-col px-6 ">
						...
						>
							<TabsList className="w-xs h-fit mb-2 bg-transparent">
								<TabsTrigger
									value="draw"
									className="flex flex-col text-gray-500 hover:text-black cursor-pointer data-[state=active]:text-blue-600 items-center gap-1 p-2 h-full data-[state=active]:shadow-none data-[state=active]:bg-blue-100 justify-center"
								>
									<Brush />
								...
								<TabsTrigger
									value="write"
									className="flex text-gray-500 flex-col hover:text-black items-center gap-1 h-full justify-center cursor-pointer data-[state=active]:text-blue-600 data-[state=active]:shadow-none p-2 data-[state=active]:bg-blue-100"
								>
									<Type />
								...
								<TabsTrigger
									value="image"
									className="flex flex-col text-gray-500 hover:text-black items-center gap-1 h-full justify-center cursor-pointer data-[state=active]:text-blue-600 data-[state=active]:shadow-none p-2 data-[state=active]:bg-blue-100"
								>
									<span>
										<Image />
									</span>
							...
							<div className="flex flex-col gap-0 w-full">
								<TabsContent
									value="draw"
									className="w-full shadow-none bg-gray-100 rounded-none"
								>
								...
								{!imageDataURL ? (
									<TabsContent
										value="image"
										className="relative flex items-center justify-center w-full !h-[256] bg-red-100 shadow-none z-10"
									>
			...
			<div className="relative flex flex-col gap-4 mt-6 items-center">
				{pdf &&
					pdf.signatures.map((signature, i) => {
						return (
							<div
								key={i}
